    ...
    <div class="row">
        <div class="col-lg-12">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active"><a href="<?php echo base_url(); ?>admin/articles"><i class="fa fa-pencil"></i> Articles</a></li>
                <li class="breadcrumb-item active" aria-current="page"><i class="fa fa-plus-square-o"></i> Edit Article</li>
            </ol>
        </div>
    </div><!-- /.row -->
    <div class="row">
        <div class="col-lg-12">
            ...
            <div class="form-group">
                ...
                <input class="form-control" style="width:40px" type="text" name="position" value="<?php echo $article->position; ?>" />
            </div>
        </div>
    </div><!-- /.row -->
</form>