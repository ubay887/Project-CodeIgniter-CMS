    ...
    <div class="row">
        <div class="col-lg-12">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page"><i class="fa fa-plus-square-o"></i> Add Article</li>
            </ol>
        </div>
    </div><!-- /.row -->
    <div class="row">
        <div class="col-lg-12">
            ...
            <div class="form-group">
                ...
                <input class="form-control" style="width:40px" type="text" name="position" value="0" />
            </div>
        </div>
    </div><!-- /.row -->
</form>